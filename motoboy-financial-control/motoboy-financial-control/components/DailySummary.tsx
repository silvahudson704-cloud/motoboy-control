...
export function DailySummary({ summary }: { summary: DaySummary }) {
  return (
    <div className="grid grid-cols-2 gap-2.5">
      ...
      <MetricCard
        label="Custo base"
        value={summary.custoBase}
        tone="cost"
        hint={summary.worked ? `${summary.totalCorridas} corridas + taxa fixa` : "sem corridas hoje"}
      />
      <MetricCard label="Gasolina" value={summary.gasolina} tone="pending" hint="separada do custo base" />
      <MetricCard
        label="Líquido"
