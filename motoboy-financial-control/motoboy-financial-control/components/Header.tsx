  ...
  return (
    <header className="safe-top sticky top-0 z-20 bg-base/95 backdrop-blur border-b border-border">
      ...
      <div className="flex gap-2 overflow-x-auto px-4 pb-3 [scrollbar-width:none]">
        <EditableAmount label="Meta diária" value={metaDiaria} onChange={onChangeMetaDiaria} />
        <EditableAmount label="Meta semanal" value={metaSemanal} onChange={onChangeMetaSemanal} />
